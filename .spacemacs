...
;; NOTE: .emacs.d SHOULD CHECKOUT develop BRANCH!
...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(moe-theme
                                      yaml-mode
                                      beancount
                                      apib-mode)
...
values."
  ...
  (setq-default
   ...
   dotspacemacs-default-font '("Inziu IosevkaCC SC"
                               :size 16
                               :weight normal
                               :width normal
                               :powerline-scale 1.0)
...
you should place your code here."
  ...
  (setq twittering-proxy-port 1081)
